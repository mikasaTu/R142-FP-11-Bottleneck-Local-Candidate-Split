...
readonly FROZEN_SOURCE_COMMIT="a1e280b64bd0eb522b036e05007f57373f403020"
STAGE_S_SOURCE_COMMIT="${STAGE_S_SOURCE_COMMIT:-$FROZEN_SOURCE_COMMIT}"
readonly FROZEN_PROTOCOL_PATH="$ROOT/logs/r142_fp11_stage_s/stage_s/protocol/FROZEN_PROTOCOL.json"
readonly ACCEPTED_ASSET_PREFLIGHT_PATH="$ROOT/logs/r142_fp11_stage_s/stage_s/protocol/ACCEPTED_A_ASSET_PREFLIGHT.json"
