...
SOURCE_COMMIT=446d7cd517545eb58476cc2593d5f013d43a75e0
...
if [ -f COMPLETED_EVALUATION_RESULT.json ] && [ -f SHA256SUMS ]; then
  ...
  echo "STAGE_R_ENGINEERING_GATES_ALREADY_COMPLETE_VALIDATED"
  exit 0
fi
mkdir -p frozen_source runtime gates runtime/tmp runtime/cache
