...
| runtime-independent-20260903 | not created | prepared, no PAI submission | A runtime is frozen to `/mnt/cpfs/zbl-cpfs-new/USERS/leon/code/r142-stage-s-a-runtime-20260903` @ `047f15c5cbad99e76ac47e2ce608a40bae22c49e`; external payload path remains `/mnt/cpfs/zbl-cpfs-new/USERS/leon/code/r142-stage-s-pai-20260902/stage_s_robotwin_a_pai.sh`. Payload SHA256: `7a4f3f998c0a99b8508eff816222a7573f209c340f2d18d72f3fd2172de85801`; the hash is bound in config and must be recomputed after every launcher byte change. |
...
| accepted-lineage-tests-20260903 | not created | passed static/dev14 checks, no PAI submission | The directed Stage-S suite passed (`53 passed`), including terminal-state, source/checkpoint, asset/model SHA, missing-pointer, tamper, metadata-lineage, replay, and shell/config tests. The canonical controller validation was attempted with the exact user-authorized run scope but currently refuses the required alias `idle-a800-robot-stage-s-graphics-8gpu` as unknown; the alias was not substituted and no PAI task was created. |
