...
| r17 | `dlc17mybd6alknp3` | active; unfinished | Exact CPFS readback contains only `/mnt/cpfs/zbl-cpfs-new/USERS/leon/logs/r142_fp11_stage_s/assets/r142-stage-s-a-assets-20260902-r17/FIRST_WORK.json` (SHA-256 `38d09764a0bf6e4559098e887acc5a96e39d910de0a64f63857357e8e7fe8a72`). The registry-side path `/mnt/cpfs/zbl-cpfs-new/USERS/leon/logs/pai_registry/r142_stage_s/assets/r142-stage-s-a-assets-20260902-r17/` has no completion marker or integrity manifest. `active`, `FIRST_WORK`, and partial cache activity do not qualify as completion or a RoboTwin result. |
...
sealed, and r17 is only active with `FIRST_WORK.json`. A valid gate requires a
